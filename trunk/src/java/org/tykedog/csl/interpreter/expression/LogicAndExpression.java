 ...
 *
 */
public class LogicAndExpression extends Expression
{
	private Expression opra;
	private Expression oprb;
	
	public LogicAndExpression(Expression opra, Expression oprb, int line)
	{
		super(line);
		this.opra = opra;
		this.oprb = oprb;
	...
	public Object execute(CallStack callstack)
	{
		...
		return callstack.calculator.logicAnd(extractVarValue(a), extractVarValue(b));
	}
