 ...
 *
 */
public class MatchEqualExpression extends Expression
{
	private Expression opra;
	private Expression oprb;
	
	public MatchEqualExpression(Expression opra, Expression oprb, int line)
	{
		super(line);
		this.opra = opra;
		this.oprb = oprb;
	...
	public Object execute(CallStack callstack)
	{
		...
		return callstack.comparator.match(extractVarValue(a), extractVarValue(b));
	}
