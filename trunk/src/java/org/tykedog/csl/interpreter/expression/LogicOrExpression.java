 ...
 *
 */
public class LogicOrExpression extends Expression
{
	private Expression opra;
	private Expression oprb;
	
	public LogicOrExpression(Expression opra, Expression oprb, int line)
	{
		super(line);
		this.opra = opra;
		this.oprb = oprb;
	...
	public Object execute(CallStack callstack)
	{
		...
		return callstack.calculator.logicOr(extractVarValue(a), extractVarValue(b));
	}
